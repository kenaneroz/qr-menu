...
export default function Basket(props) {
    ...
    return (
        <div className={`bg-gray-500 w-full h-screen z-999 absolute bottom-0 left-0 transform ${props.basketActive ? 'translate-x-[0]' : 'translate-x-[100%]'} transition duration-250 ease-in-out overflow-x-hidden overflow-y-scroll p-[25px]`}>
