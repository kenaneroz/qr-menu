    ...
    return (
        <header className="bg-[url(/business.jpg)] bg-cover bg-center pb-[125px]">
            <div className="bg-white flex justify-between items-center px-[25px] py-[10px]">
                <select name="languages" id="languages" className="appearance-none cursor-pointer bg-[#50110A] text-white h-max rounded-full p-[2px]" onChange={props.setSelectedLanguage}>
                    <option value="English">English</option>
                    <option value="Turkish">Türkçe</option>
                </select>
                <div className="flex items-center gap-[10px]">
                    {
                        props.searchBoxVisibility &&
                        <textarea 
                            placeholder={props.langs.translations[props.selectedLanguage].searchBoxPlaceholder}
                    ...
                    <LuSearch
                        ...
                        onClick={props.showHideSearchBox}
                    />
                    <div 
                    ...
                    >
                        <MdOutlineShoppingCart
                            className="text-[#50110A] text-2xl"
                            onClick={props.showBasket}
                        />
                    ...
                    <GiHamburgerMenu 
                        ...
                        onClick={() => props.setSidebarVisibility(true)}
                    />
                    {
                        props.sidebarVisibility &&
                        <div className="bg-[#50110A] text-white h-dvh w-full absolute top-0 left-0 z-50 p-[25px]">
                            <IoMdClose 
                                className="cursor-pointer text-xl mb-[25px]" 
                                onClick={() => props.setSidebarVisibility(false)}
                            />
                            <div>
                                <img src="/business.jpg" alt="Business" className="h-[125px] w-full object-cover rounded-[35px]" />
