...
export default function Details(props) {
    ...
    return (
        <div className={`bg-gray-500 h-dvh w-full z-999 absolute top-0 left-0 transform ${props.detailsActive ? 'translate-y-[0]' : 'translate-y-[100%]'} transition duration-250 ease-in-out overflow-x-hidden overflow-y-scroll text-center p-[25px]`}>
            <IoMdClose 
